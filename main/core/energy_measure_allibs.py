...
# Measured from your timing experiment
# =========================================================
...
# MEASURE FUNCTION
# Supports:
#   1) fixed-rate mode: rate + duration_s
#   2) fixed-count mode: num_logs
# =========================================================
def measure(
    *,
    project_name,
    ...
    # -----------------------------------------------------
    # Sleep before run (cool-down / stabilization)
    # -----------------------------------------------------
    ...
    # Ideal gap between starts of consecutive logs
    interval = 1.0 / rate

    # Sleep time using measured avg library cost
